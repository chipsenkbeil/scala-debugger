package org.scaladebugger.api.lowlevel.jvm.exceptions
...
import org.scaladebugger.api.lowlevel.jvm.requests.properties.{SuspendPolicyProperty, EnabledProperty}
