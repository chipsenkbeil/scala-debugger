package org.scaladebugger.api.lowlevel.interfaces.requests.filters.processors

import com.sun.jdi.request._
import org.scaladebugger.api.lowlevel.jvm.requests.filters.{JDIRequestFilter, JDIRequestFilterProcessor, ClassExclusionFilter}
...
class ClassExclusionFilterProcessor(
   ...
   */
  ovrride def process(eventRequest: EventRequest): EventRequest = {
