package org.scaladebugger.api.lowlevel.interfaces.events.data.requests

import org.scaladebugger.api.lowlevel.jvm.events.JDIEventProcessor
import org.scaladebugger.api.lowlevel.jvm.events.data.JDIEventDataRequest
import org.scaladebugger.api.lowlevel.jvm.events.data.processors.CustomPropertyDataRequestProcessor
