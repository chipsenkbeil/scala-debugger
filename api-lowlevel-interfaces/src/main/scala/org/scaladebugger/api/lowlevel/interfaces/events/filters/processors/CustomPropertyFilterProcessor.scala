package org.scaladebugger.api.lowlevel.interfaces.events.filters.processors

import com.sun.jdi.event.Event
import org.scaladebugger.api.lowlevel.jvm.events.filters.{CustomPropertyFilterLike, JDIEventFilter, JDIEventFilterProcessor, CustomPropertyFilter}
