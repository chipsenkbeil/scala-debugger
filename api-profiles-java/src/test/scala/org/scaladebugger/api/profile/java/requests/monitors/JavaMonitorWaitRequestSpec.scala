...
import org.scaladebugger.api.lowlevel.jvm.events.EventType.MonitorWaitEventType
...
import org.scaladebugger.api.lowlevel.jvm.monitors.{MonitorWaitManager, MonitorWaitRequestInfo, PendingMonitorWaitSupportLike}
