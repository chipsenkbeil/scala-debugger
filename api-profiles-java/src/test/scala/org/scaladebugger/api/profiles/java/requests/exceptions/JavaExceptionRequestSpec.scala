...
import org.scaladebugger.api.lowlevel.jvm.events.EventType.ExceptionEventType
...
import org.scaladebugger.api.lowlevel.jvm.exceptions.{ExceptionManager, ExceptionRequestInfo, PendingExceptionSupportLike}
