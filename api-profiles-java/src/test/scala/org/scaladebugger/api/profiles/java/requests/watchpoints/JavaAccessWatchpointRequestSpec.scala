...
import org.scaladebugger.api.lowlevel.jvm.events.EventType.AccessWatchpointEventType
...
import org.scaladebugger.api.lowlevel.jvm.watchpoints.{AccessWatchpointManager, AccessWatchpointRequestInfo, PendingAccessWatchpointSupportLike}
